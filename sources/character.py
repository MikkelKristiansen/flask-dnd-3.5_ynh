...
# Dataklasserne + validering bor nu i models.py; character.py re-eksporterer dem
# (façade), så char_module.Character / AbilityScores m.fl. virker uændret.
...
# Statisk referencedata (racer/sprog/klasser/feats) bor nu i refdata.py;
# character.py re-eksporterer navnene (façade), så char_module.race_data /
# hit_die / feat_id m.fl. og de lokale kald nedenfor virker uændret.
from refdata import (  # noqa: F401
    hit_die, skill_points_per_level, is_feat_level, is_ability_level, class_skills,
    race_data, STANDARD_LANGUAGES, class_languages, race_bonus_languages,
