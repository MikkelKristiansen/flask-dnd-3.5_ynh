...
testes uden Flask, og det er også derfor testsuiten kører 702 tests på ~30
sekunder.
...
routes_*.py          Blueprints: combat, companion, inventory, progression, spells, summon
...
templates/           33 Jinja2-templates      static/   CSS + 12 JS-moduler
...
!!! note "Et løst hjørne"
    Der er **31** af de udskudte `from app import _char_path`-linjer fordelt på
    seks blueprint-filer. `route_helpers.py` findes præcis for at bryde denne
...
- [Ruter](ruter.md) — alle 81 ruter (genereret)
